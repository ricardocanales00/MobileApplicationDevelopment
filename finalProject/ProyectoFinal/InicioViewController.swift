                        ...
                        if let document = documentSnapshot, error == nil{
                            if let telefono = document.get("telefono") as? String{
                                if let usuario = document.get("usuario") as? String{
                                    if let cargo = document.get("cargo") as? String, let correo = document.get("correo") as? String, let admin = document.get("admin") as? Bool{
                                        ...
                                        if  verificacion == true{
                                            ...
                                            user.set(Bool(admin), forKey: "admin")
