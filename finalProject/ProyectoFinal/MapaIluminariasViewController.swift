//
//  MapaIluminariasViewController.swift
//  ProyectoFinal
//
...
class MapaIluminariasViewController: UIViewController, UIScrollViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        vistaFoto = UIImageView(image: UIImage(named: "iluminarias")!)
